...
export default function ChessGame() {
  ...
  // Use refs to avoid stale closure / effect re-trigger issues
  ...
  // AI move trigger — only re-runs when state/config/showSetup change
  // aiThinking intentionally NOT in deps to prevent timer self-cancellation
  useEffect(() => {
    ...
    timerRef.current = setTimeout(() => {
      // Read latest refs at execution time
      ...
      try {
        ...
        // ignore errors, just reset thinking
      } finally {
