...
export const ENDGAME_POSITIONS: EndgamePosition[] = [
  // ===== 兵局 (20) =====
  {
    id: 1, category: '兵局', name: '對立爭先——d兵', difficulty: 2,
    fen: '8/8/8/8/2k5/8/3P4/3K4 w - - 0 1',
    goal: '白方獲勝', playerColor: 'w',
    hint: '黑王已深入，白方需精確取對立來護送 d 兵升變',
  },
  {
  ...
  {
    id: 3, category: '兵局', name: 'a邊兵——和棋', difficulty: 2,
    fen: 'k7/8/K7/P7/8/8/8/8 w - - 0 1',
    goal: '和棋', playerColor: 'b',
    hint: '黑王只需守住 a8 角落，白方無法突破',
  },
  {
    id: 4, category: '兵局', name: 'h邊兵——逼和陷阱', difficulty: 2,
    fen: '7k/8/6KP/8/8/8/8/8 w - - 0 1',
    goal: '和棋', playerColor: 'b',
    hint: '黑王回到 h8，讓白方陷入逼和困局',
  },
  {
    id: 5, category: '兵局', name: 'd兵關鍵格', difficulty: 2,
  ...
  {
    id: 10, category: '兵局', name: '方格法則', difficulty: 2,
  ...
  {
    id: 14, category: '兵局', name: '黑兵升變護送', difficulty: 2,
  ...
  // ===== 車局 (25) =====
  {
    id: 21, category: '車局', name: '車王殺局——黑王在中央', difficulty: 2,
    fen: '8/8/8/8/8/8/4k3/R5K1 w - - 0 1',
    goal: '白方獲勝', playerColor: 'w',
    hint: '黑王躲在中央，需先用車切割再配合白王驅逐到邊緣',
  },
  {
  ...
  {
    id: 39, category: '車局', name: '雙車對王——黑王居中', difficulty: 2,
    fen: '8/8/3k4/8/8/8/8/R1R1K3 w - - 0 1',
    goal: '白方獲勝', playerColor: 'w',
    hint: '黑王在棋盤中央，需協調雙車把黑王趕到邊緣再殺局',
  },
  {
  ...
  // ===== 象局 (15) =====
  {
    id: 46, category: '象局', name: '象+兵——正色', difficulty: 2,
    fen: '8/8/8/8/8/3B4/3P4/3K3k w - - 0 1',
    goal: '白方獲勝', playerColor: 'w',
    hint: '象與升變格同色，白方應能獲勝',
  },
  {
    id: 47, category: '象局', name: 'a兵錯色象——和棋', difficulty: 2,
    fen: '8/8/8/8/8/7k/7P/6KB1 w - - 0 1',
    goal: '和棋', playerColor: 'b',
    hint: 'h兵升變格是暗色，白象是亮色（錯色）——和棋',
  },
  {
    id: 48, category: '象局', name: '異色象——和棋', difficulty: 2,
  ...
  {
    id: 62, category: '馬局', name: '馬無法逼殺', difficulty: 2,
  ...
  // ===== 后局 (10) =====
  {
    id: 71, category: '后局', name: '后+王殺局——黑王居中', difficulty: 2,
    fen: '8/8/8/3k4/8/8/8/Q4K2 w - - 0 1',
    goal: '白方獲勝', playerColor: 'w',
    hint: '黑王在中央有更多逃跑空間，需避免逼和並精確殺局',
  },
  {
  ...
  {
    id: 78, category: '后局', name: '后+兵——快速升變', difficulty: 2,
